...
(function() {
  ...
  function initLocalStorageData() {
    ...
    safeSetItem('abc_users', JSON.stringify(state.users));
      ...
      if (savedUser) {
        ...
        if (matched) {
          safeSetItem('abc_current_user', JSON.stringify(matched));
        }
      }
    }
  ...
  function renderBranches() {
    ...
    if (matrix) {
      ...
      let footerHtml = `
        <tr style="background: rgba(99, 102, 241, 0.05); border-top: 1.5px solid rgba(255,255,255,0.12); border-bottom: 1.5px solid rgba(255,255,255,0.12);">
